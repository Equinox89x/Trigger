...
AA_Weapon::AA_Weapon()
{
    ...
    static ConstructorHelpers::FObjectFinder<USkeletalMesh> loadedObject(TEXT("/Script/Engine.SkeletalMesh'/Game/Weapons/Colt/SkeletalMesh/skeletalgun2.skeletalgun2'"));
