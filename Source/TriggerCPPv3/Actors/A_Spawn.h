...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Spawn)
	UChildActorComponent* SherrifSpawnComp {nullptr};
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Spawn)
	UChildActorComponent* BanditSpawnComp { nullptr };
	...
	APlayerStart* GetBanditSpawn() { return Cast<APlayerStart>(BanditSpawnComp->GetChildActor()); };
	APlayerStart* GetSheriffSpawn() { return Cast<APlayerStart>(SherrifSpawnComp->GetChildActor()); };
