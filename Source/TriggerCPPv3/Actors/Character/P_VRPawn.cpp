...
AP_VRPawn::AP_VRPawn()
{
	...
	#pragma region Belt
	static ConstructorHelpers::FObjectFinder<UStaticMesh> belt(TEXT("/Script/Engine.StaticMesh'/Game/Characters/Cowboy/meshes/Belt_pTorus1.Belt_pTorus1'"));
	Belt->SetStaticMesh(belt.Object);
	static ConstructorHelpers::FObjectFinder<UStaticMesh> lHolster(TEXT("/Script/Engine.StaticMesh'/Game/Characters/Cowboy/meshes/Belt_polySurface11.Belt_polySurface11'"));
	RightHolster->SetStaticMesh(lHolster.Object);
	static ConstructorHelpers::FObjectFinder<UStaticMesh> rHolster(TEXT("/Script/Engine.StaticMesh'/Game/Characters/Cowboy/meshes/Belt_polySurface1.Belt_polySurface1'"));
	...
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> charObj(TEXT("/Script/Engine.SkeletalMesh'/Game/Characters/Cowboy/meshes/PlayerRigged__2_.PlayerRigged__2_'"));
	CharacterMesh->SetSkeletalMeshAsset(charObj.Object);
	static ConstructorHelpers::FObjectFinder<UMaterial> charMat(TEXT("/Script/Engine.Material'/Game/Characters/Cowboy/Materials/Material_001.Material_001'"));
